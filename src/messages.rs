...
pub trait FilterPlaneLoaded: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterPlaneLoaded rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterVR: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterVR rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterLivery: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterLivery rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterFmod: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterFmod rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterAirportLoaded: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterAirportLoaded rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterWritePrefs: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterWritePrefs rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterReleasePlanes: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterReleasePlanes rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterSceneryLoaded: crate::plugin::Plugin {
...
pub trait FilterPlaneCrashed: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterPlaneCrashed rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterAirplaneCountChanged: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterAirplaneCountChanged rx_message: msg:{} param:{}", message, param as i32);
...
pub trait FilterDatarefsAdded: crate::plugin::Plugin {
    ...
    fn rx_message(&mut self,
        ...
        // debugln!("rust-xplm: messages.rs: trait FilterDatarefsAdded rx_message: msg:{} param:{}", message, param as i32);
